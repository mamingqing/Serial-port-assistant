    ...
    public partial class Form1 : Form
    {
        ...
        private void btnopen_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (serialPort1.IsOpen)
                {
                    ...
                    btnopen.Text = "打开串口";
                    btnopen.BackColor = Color.ForestGreen;
                    ...
                    checkBox3.Enabled = false;      //自动发送按钮失能
                    checkBox2.Enabled = false;      //发送新行按钮失能
                ...
                else
                {
                    ...
                    btnopen.BackColor = Color.Firebrick;
        ...
        private void serialPort1_DataReceived(object sender, System.IO.Ports.SerialDataReceivedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (is_need_time && checkBox1.Checked)
                    {
                        /* 需要加时间戳 */
        ...
        private void btnsend_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (serialPort1.IsOpen)
                {
                    ...
                    /* 记录发送数据 */
                    //先检查当前是否存在该项
                    if (comboBox7.Items.Contains(textBox_send.Text) == true)
                    {
                        return;
                    }
                    else
                    {
                        comboBox7.Items.Add(textBox_send.Text);
                    }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            /* 获取当前接收区内容 */
            String recv_data = textBox_receive.Text;
            if (recv_data.Equals(""))
            {
        ...
        {
            //清空发送缓冲区
            textBox_send.Text = comboBox7.SelectedItem.ToString();
        }

        private void timer2_Tick(object sender, EventArgs e)
        {
            btnsend_Click(btnsend, new EventArgs());    //调用发送按钮回调函数
        }
        ...
        private void linkLabel1_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            string targetUrl = "https://github.com/mamingqing/Serial-port-assistant.git";
